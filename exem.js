let militaryUnit = {
  ...
  function Mission1(UnitObj){
    console.log(`${militaryUnit.commandStructure.chiefOfStaff.rank} ${militaryUnit.commandStructure.chiefOfStaff.name}  ${militaryUnit.commandStructure.chiefOfStaff.contact.phone}`);
